...
<template>
  <div class="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 lg:gap-x-4 mt-20 items-center lg:bg-transparent lg:shadow-none lg:p-0">
    <!-- Icon -->
    <div class="relative col-span-full md:col-span-4 lg:col-span-5 flex justify-center md:justify-start lg:justify-end md:order-1 lg:order-1">
      <slot name="icon">
      ...
      <img alt="Dashed line" class="absolute top-[115.35px] right-[228px] w-[13.575px] h-[185px] block rotate-45 hidden lg:block" src="/img/dashed-line.svg" />
    </div>
    ...
    <div class="col-span-full md:col-span-8 lg:col-span-7 pt-6 md:pt-0 md:pl-6 lg:pl-4 text-center md:text-left md:order-2 lg:order-2">
      ...
      <p class="text-gray-700 text-lg">
        If you lose your Tefilin, mark it as lost on our site to have it posted on our virtual lost &amp; found, activate trackers, and alert our partners on major websites.
      </p>
    </div>
  </div>
</template>
...
<script setup>
// No script needed unless you want to make props for dynamic text or SVG
</script>
<style scoped>
