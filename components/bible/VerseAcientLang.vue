<template>
        ...
        >
          ...
          <span class="text-gray-800 dark:text-gray-300">
            ...
            <div class="flex justify-end items-center space-x-2">
              <!-- Places Icon -->
              <svg v-if="verse.places && verse.places.length > 0" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
              ...
              <!-- Notes Icon -->
              <svg v-if="verse.notes && verse.notes.length > 0" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  props: {
    ...
    userId: { type: Number, required: false }, // Accept userId as a prop
  },
