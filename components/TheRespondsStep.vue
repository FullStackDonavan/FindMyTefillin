...
<template>
  <div class="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 lg:gap-x-4 mt-20 items-center lg:bg-transparent lg:shadow-none lg:p-0">
    ...
    <div class="relative col-span-full md:col-span-4 lg:col-span-3 flex justify-center md:justify-start">
      ...
      <img alt="Dashed line" class="absolute top-[125.85px] w-[13.575px] h-[220px] block -rotate-45 hidden lg:block" src="/img/dashed-line.svg" style="left: calc(220.8px);" />
    </div>

    <!-- Text -->
    <div class="col-span-full md:col-span-8 lg:col-span-7 pt-6 md:pt-0 md:pl-6 lg:pl-4 text-center md:text-left">
      <h4 class="font-montserrat font-normal uppercase text-gray-900 text-xl leading-tight mb-3">The Response</h4>
      <p class="text-gray-700 text-lg">
        Whoever finds your tefilin uses the MyTefilinTag™ to contact us. As a registered user you are notified instantly by phone and email.
      </p>
    </div>
  </div>
</template>
...
<script setup>
// Optional: add props if you want title and description to be dynamic
</script>
<style scoped>
