...
// Function to navigate to the 'Create Ad' page
function goToAdCreationForm() {
  if (isLoggedIn) {
...
<template>
  <div>
      ...
      <div class="w-100" aria-label="Sidebar">
        <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-900">
          <ul class="space-y-2">
            ...
            <!-- Add new "Create Ad" option to sidebar -->
            <li>
              <NuxtLink
                to="/dashboard/create-ad"
                class="flex items-center text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                @click="goToAdCreationForm"
              >
                <Icon
                  ...
                  size="45"
                />
                <span class="flex-1 whitespace-nowrap">Create Ad</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink
    ...
    <!-- Add the AdCreativeForm Component here -->
    <AdCreativeForm v-if="route.path === '/dashboard/create-ad'" />
  </div>
</template>
