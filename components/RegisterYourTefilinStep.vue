  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 lg:gap-x-4 mt-20 items-center lg:bg-transparent lg:shadow-none lg:p-0">
    ...
    <div class="relative col-span-full md:col-span-4 lg:col-span-3 flex justify-center md:justify-start">
      ...
      <img
        v-if="showDashedLine"
        alt="Dashed line"
        class="absolute top-[115.35px] w-[13.575px] h-[190px] block -rotate-45 hidden lg:block"
        src="/img/dashed-line.svg"
        :style="{ left: dashedLineLeft }"
      />
    </div>
...
const props = defineProps({
  title: { type: String, default: "Register your tefilin" },
  description: { 
    type: String, 
    default: "It's Simple. Submit your contact information and details of your tefilin into the world's first and only international tefilin registry on the planet. Get your MyTefilinTag™ with your unique ID and attach it to your Tefilin Bag." 
  },
  showDashedLine: { type: Boolean, default: true },
  dashedLineLeft: { type: String, default: "calc(225.8px)" }
});
</script>
<style scoped>
  .how-icon-register-1 { fill: #3498db; }
  .how-icon-register-2 { fill: #333; }
  .how-icon-register-3 { fill: #fff; }
</style>